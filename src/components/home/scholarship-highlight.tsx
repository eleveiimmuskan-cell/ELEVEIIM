  ...
  return (
    <SectionReveal id="scholarship" className="bg-brand/5 py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <StaggerContainer className="grid items-center gap-12 lg:grid-cols-2" stagger={0.12}>
          <StaggerItem>
            <div>
                <SectionHeader
                  align="left"
                  eyebrow="Scholarship Program"
                  title="Up to 100% Fee Waiver Available for Top Performers"
                  description=" scholarships make premium education accessible. Apply today — limited seats."
                />
          ...
          <StaggerItem>
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl font-bold text-foreground">GET Upto 100%  SCHOLARSHIP</h3>
