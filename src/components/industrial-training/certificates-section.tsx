...
export function CertificatesSection() {
  return (
    <SectionReveal id="brochure" className="py-16 sm:py-20" aria-labelledby="certificates-heading">
        ...
        <StaggerContainer className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {CERTIFICATES.map((cert) => (
            <StaggerItem key={cert.title}>
              <article className="overflow-hidden rounded-2xl border border-[#0B63CE]/10 bg-white shadow-[0_4px_20px_rgba(11,99,206,0.08)]">
